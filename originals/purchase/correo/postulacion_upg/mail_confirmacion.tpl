...
<table width="100%"  border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td style="text-align:center;"><table width="600" border="0" cellspacing="0" cellpadding="0" style="border: 1px solid #CCC; margin:0 auto;">
        ...
        <tr>
          <td style="font: normal 12px Arial, Helvetica, sans-serif; color: #333; padding: 20px 8px 15px 10px; text-align:left;"><p><strong>{_ESTIMADO} {NOMBRE_LEAD_PASSENGER}</strong>&#44;<br>
          </p> </td>
        </tr>
		
        <tr>
          <td style="font: bold 15px Arial, Helvetica, sans-serif; color: #033D7D; padding: 0 8px 10px 10px; text-align:left;">{_LABEL_CODIGO_RESERVA}: {PNR}</td> 
        </tr>
		<tr>
		...
		<table width="100%" border="0" cellspacing="0" cellpadding="0" style="line-height: 110%; border-top: 1px solid #CCCCCC; border-collapse: collapse;">
		<tr>
		<th colspan="5" style="background:#DCDFEE; text-align: left; font-weight: bold; font-size: 11px; font-family: Arial, Helvetica, sans-serif; color: #333; padding: 5px 0px 0px 5px; border-left:1px solid #CCCCCC; border-right:1px solid #CCCCCC;">{_LABEL_ITINERARIO}</th>
		</tr>
		<tr>
			<td>
			<lan:widget class="Widgets::Upg::Despliegue_Info_Reserva">
				<lan:value>{SESSION_ID}</lan:value>
				<lan:value>{CONTEXT_ID}</lan:value>
				<lan:value>{DESPLIEGUE_PASO_3}</lan:value>
			</lan:widget>
			</td>
		</tr>
		</table><br>
		...
		<table width="100%" border="0" cellspacing="0" cellpadding="0" style="line-height: 110%; border-top: 1px solid #CCCCCC; border-collapse: collapse;">
        <tr>
        <th colspan="5" style="background: #DCDFEE; text-align: left; font-weight: bold; font-size: 11px; font-family: Arial, Helvetica, sans-serif; color: #333; padding: 4px 2px 2px 5px; border-left:1px solid #CCCCCC; border-right:1px solid #CCCCCC; ">{_LABEL_UPG_POSTULACION_PASAJERO}</th>
        </tr>	
		<tr>
			<td>
		...
		<table width="100%" border="0" cellspacing="0" cellpadding="0" style="line-height: 110%; border-top: 1px solid #CCCCCC; border-collapse: collapse;">
 		<tr>
		<th colspan="7" style="background: #DCDFEE; text-align: left; font-weight: bold; font-size: 11px; font-family: Arial, Helvetica, sans-serif; color: #333; padding: 4px 2px 2px 5px; border-left: 1px solid #CCCCCC; border-right: 1px solid #CCCCCC; ">{_LABEL_UPG_RESUMEN_CUPONES}</th>
        </tr>
		<tr>
			<td>
