...
{/AMIGOS_SELECT}
  ...
  <tr>
    ...
    <td id="id_pax_{PAX_TYPE}_{NUM_PAX}_foid_pais">
      <select style="width:100px" class="combo-box" name="pax_{PAX_TYPE}_{NUM_PAX}_foid_pais" id="pax_{PAX_TYPE}_{NUM_PAX}_foid_pais" onchange="cargar_pax_notificables(this.form, '{NUM_PAX}');apply_other_foid_type_by_home_country(this, '{PAX_TYPE}','{NUM_PAX}','{PAIS_HOME}', 'PP', '{_LABEL_PASAPORTE}');">
    ...
    <td id="id_pax_{PAX_TYPE}_{NUM_PAX}_foid_tipo">
      <select class="combo-box" name="pax_{PAX_TYPE}_{NUM_PAX}_foid_tipo" id="pax_{PAX_TYPE}_{NUM_PAX}_foid_tipo" onChange="check_foid_no_aplica(this.form, '{PAX_TYPE}', '{NUM_PAX}')" style="width: 120px;">
    ...
    <td id="id_pax_{PAX_TYPE}_{NUM_PAX}_foid_numero">
      <input type="text" class="input" name="pax_{PAX_TYPE}_{NUM_PAX}_foid_numero" id="pax_{PAX_TYPE}_{NUM_PAX}_foid_numero" value='{FOID_VALUE}' size="8" maxlength="30" {FOID_DISABLED} onBlur="cargar_pax_notificables(this.form, '{NUM_PAX}');">
    </td>
  ...
  <tr>
    <td colspan="8">{_MSG_RECONFIRME_CAMPOS_OBLIGATORIOS}<br /><br/>{ADD_INPUT}&nbsp;{_LABEL_AGREGAR_AMIGOS}<br/>
      <br/>
      {INFO_VIAJES_POR_ORIGEN}</td>
  </tr>
  {DATOS_TSA}
{EXTRA_INPUT_DATA}
</table>
