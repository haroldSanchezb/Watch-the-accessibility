...
function check_paxs(f, tipo_pax, tipo_pax_txt, cantidad)
    ...
    for (i = 1; i <= cantidad; i++)
        ...
        change_bg_for_id("id_pax_" + tipo_pax + "_" + i + "_segundo_apellido", 'ok');
        ...
        elem = eval("f.elements['pax_" + tipo_pax + "_" + i + "_segundo_apellido']");
        if (elem != null) {
                    if (!elem || elem.value.length < 2)
                        {
                         errores += "{_ERROR_PASAJERO_SIN_SEGUNDO_APELLIDO_JS} " + tipo_pax_txt + " " + i + "\n";
                             change_bg_for_id("id_pax_" + tipo_pax + "_" + i + "_segundo_apellido", 'dato-erroneo');
                        }
        }
        ...
        if (get_pais() =="es-ar" && elem && elem.value != "N/A")
            ...
            if (elem2.value.length < 1)
                ...
                errores += "{_MSG_DEBE_INGRESAR_CUIT_CUIL_JS}" + tipo_pax_txt + " " + i + "\n";
                    ...
                    {
                    if (validaCuit(elem2) || elem2.value.length != 11)
                        {
