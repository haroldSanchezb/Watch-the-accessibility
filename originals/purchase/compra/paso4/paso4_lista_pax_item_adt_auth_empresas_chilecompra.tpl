<table class="table" width="100%" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr>
    ...
    <th rowspan="2" style="padding-left: 15px;"></th>
  ...
  <tr>
	...
	<td>
	 	<input name="pax_{PAX_TYPE}_{NUM_PAX}_ff_airline" id="pax_{PAX_TYPE}_{NUM_PAX}_ff_airline" type="hidden" class="input" value="LA">
		<input name="pax_{PAX_TYPE}_{NUM_PAX}_ff_number" id="pax_{PAX_TYPE}_{NUM_PAX}_ff_number" type="hidden" class="input" value="7114007204" size="10" maxlength="30">
	</td>
