...
{/AMIGOS_SELECT}
  ...
  <tr>
    ...
    <td id="id_pax_{PAX_TYPE}_{NUM_PAX}_foid_pais"><select style="width:100px" class="combo-box" name="pax_{PAX_TYPE}_{NUM_PAX}_foid_pais" id="pax_{PAX_TYPE}_{NUM_PAX}_foid_pais" onchange="cargar_pax_notificables(this.form, '{NUM_PAX}');">
