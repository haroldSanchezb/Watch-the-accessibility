<table class="table" width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td class="sub-titulo" colspan="5" style="padding:0 0 0 8px;">{PAX_TYPE_TXT}</td>
  </tr>
{*AMIGOS_SELECT}
  <tr>
    <td class="sub-titulo" colspan="5" style="padding:0 0 0 8px; border-top:1px solid #DCE0EE;">{_LABEL_MIS_AMIGOS}&nbsp;{PAX_SELECT}</td>
  </tr>
{/AMIGOS_SELECT}
  <tr>
  ...
  <tr>
    <td colspan="5">{ADD_INPUT}&nbsp;{_LABEL_AGREGAR_AMIGOS}<br/>
      <br/>
