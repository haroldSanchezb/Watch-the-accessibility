...
<tr>
	<td colspan='2'>
		...
		<select class='combo-box' name="pax_{PAX_TYPE}_{NUM_PAX}_ff_airline" id="pax_{PAX_TYPE}_{NUM_PAX}_ff_airline">
			<option value=''>&nbsp;</option>
			{FF_AIRLINES}
		</select>&nbsp;<input type=text class=input name="pax_{PAX_TYPE}_{NUM_PAX}_ff_number" id="pax_{PAX_TYPE}_{NUM_PAX}_ff_number" value='{FF_NUM_VALUE}' size="15" maxlength="30">
	</td>
	<td colspan='3'>
