<table class="table" width="100%" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr>
    ...
    <td id="id_pax_{PAX_TYPE}_{NUM_PAX}_foid_pais"><select style="width:100px" class=combo-box name="pax_{PAX_TYPE}_{NUM_PAX}_foid_pais" id="pax_{PAX_TYPE}_{NUM_PAX}_foid_pais" onchange="apply_other_foid_type_by_home_country(this,'{PAX_TYPE}','{NUM_PAX}','{PAIS_HOME}', 'PP', '{_LABEL_PASAPORTE}')">
