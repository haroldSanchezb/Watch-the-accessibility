...
<input type=radio name="forma_pago" id="id_CREDIT_CARD_COBRANDING" value="CREDIT_CARD" onChange="flag_cobranding.value='on';extra_datos(this.form)" onClick="flag_cobranding.value='on';extra_datos(this.form)">
...
<br><hr><br>
<strong>Eingabe Ihrer Kreditkarteninformationen:</strong>
<BR><BR>
<table>
  <tr>
	<td></td>
