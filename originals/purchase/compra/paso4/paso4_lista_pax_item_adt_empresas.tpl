<table class="table" width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td class="sub-titulo" colspan="7" style="padding-left:8px; padding-bottom:2px; padding-top:2px;">{_LABEL_FUNCIONARIO}&nbsp;{PAX_SELECT}</td>
  </tr>
  <tr>
  ...
  <tr>
    ...
    <td id="id_pax_{PAX_TYPE}_{NUM_PAX}_nombre"><input name="pax_{PAX_TYPE}_{NUM_PAX}_nombre" id="pax_{PAX_TYPE}_{NUM_PAX}_nombre" type="text" class="input" onBlur="txt2sabre_txt(this);cargar_pax_notificables(this.form, '{NUM_PAX}');" value='{NOMBRE_VALUE}' size="7" maxlength="30">	</td>
    <td id="id_pax_{PAX_TYPE}_{NUM_PAX}_primer_apellido"><input name="pax_{PAX_TYPE}_{NUM_PAX}_primer_apellido" id="pax_{PAX_TYPE}_{NUM_PAX}_primer_apellido" type="text" class="input" onBlur='txt2sabre_txt(this);cargar_pax_notificables(this.form, '{NUM_PAX}');' value='{APELLIDO_VALUE}' size="7" maxlength="30">	    </td>
    ...
    <td><select style="width: 125px;" class="combo-box" name="pax_{PAX_TYPE}_{NUM_PAX}_ff_airline" id="pax_{PAX_TYPE}_{NUM_PAX}_ff_airline">
	   ...
	   <input name="pax_{PAX_TYPE}_{NUM_PAX}_ff_number" id="pax_{PAX_TYPE}_{NUM_PAX}_ff_number" type="text" class="input" value='{FF_NUM_VALUE}' size="8" maxlength="30">	 </td>
    ...
    <td id="id_pax_{PAX_TYPE}_{NUM_PAX}_foid_numero"><input name="pax_{PAX_TYPE}_{NUM_PAX}_foid_numero" id="pax_{PAX_TYPE}_{NUM_PAX}_foid_numero" type="text" class="input" value='{FOID_VALUE}' size="8" maxlength="30" onBlur="cargar_pax_notificables(this.form, '{NUM_PAX}');">	</td>
