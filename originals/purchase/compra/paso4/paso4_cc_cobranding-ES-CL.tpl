...
<input type=radio name="forma_pago" id="id_CREDIT_CARD_COBRANDING" value="CREDIT_CARD" onChange="flag_cobranding.value='on';fp_flavour.value='SANTANDER';extra_datos_cobranding(this.form)" onClick="flag_cobranding.value='on';extra_datos_cobranding(this.form)">
