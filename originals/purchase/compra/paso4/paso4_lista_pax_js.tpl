...
function update_field_value(form_element, new_value) {
...
function completa(f, id_pax, type_pax)
	...
	var add = ["1",{ADD}];
		...
		update_field_value(f['pax_' + type_pax + '_' + id_pax + '_foid_pais'], (foid_pais[f['pax_' + type_pax + '_' + id_pax].value]));
		...
		if (type_pax == 'ADT')  {
			update_field_value(f['pax_' + type_pax + '_' + id_pax + '_ff_airline'],
			(ff_airline[f['pax_' + type_pax + '_' + id_pax].value]));
