...
<table class=table width="100%" cellpadding="0" cellspacing="0">
  ...
  <tr class="sub-titulo">
    <td id="id_tipo_tarjeta" colspan="5"> {_LABEL_TIPO_TARJETA} <b>{TIPO_TARJETA_NAME}</b>
        <input type="hidden" name="tipo_tarjeta" id="tipo_tarjeta" value="{TIPO_TARJETA}">    </td>
  </tr>
  <tr>
    <td id="id_n_tarjeta"><label> {_LABEL_NUMERO_TARJETA} </label>
        ...
        <input type="hidden" name="n_tarjeta">    </td>
    <td id="id_fecha_exp"><label> {_LABEL_FECHA_EXPIRACION} </label>
        <input type="hidden" name="fecha_exp">
        <select name="exp_month" class=combo-box>
          <option selected value=''> {_LABEL_MES} </option>
        ...
        <select name="exp_year" class=combo-box>
          <option selected value=''> {_LABEL_ANO} </option>
    ...
    <td colspan="3" id="id_digito_verificador"><label>{_LABEL_CODIGO_VERIFICACION}</label>
        <input type=text class=input name="digito_verificador" size="5" maxlength="{LARGO_DIGITO_VERIFICADOR}">
      &nbsp;&nbsp;<a href="javascript:mostrar_layer_cod();"><img src="/images/reservas/compra/help_icon2.gif" width="15" height="15" border="0" alt="{_TEXTO_LINK_AYUDA}"></a>&nbsp;&nbsp;<a href="javascript:mostrar_layer_cod();">{_TEXTO_LINK_AYUDA}</a> </td>
  </tr>
  <tr class="sub-titulo">
    <td id="id_nombre_titular"><label> {_LABEL_NOMBRE_TITULAR} </label>
        <input type=text class=input name="nombre_titular" size='20' onChange="javascript:limpiaTexto(this);" value='{NOMBRE_TITULAR}' maxlength="15">    </td>
    <td id="id_apellido_titular"><label> {_LABEL_APELLIDO_TITULAR} </label>
        <input type=text class=input name="apellido_titular" size='20' onChange="javascript:limpiaTexto(this);" value='{APELLIDO_TITULAR}'>    </td>
    <!--{*BLOQUE_FOID}
    <td id="id_tipo_foid" colspan="3"><label> {_LABEL_DOCUMENTO_ID} </label>
    ...
    <td>&nbsp;</td>
    <td>&nbsp;</td>
    <!-- eleiminar este <td> si se descomenta el BLOQUE FOID -->
    <td>
    {*BLOQUE_NO_FOID}
  ...
  <tr>
    <td id="id_tarjeta_street"><label> {_LABEL_CALLE} </label>
        <input type=text class=input name="tarjeta_street" onChange="javascript:limpiaTexto(this);" size="30"></td>
    <td id="id_tarjeta_housenumber"><label> {_LABEL_NUMERO} </label>
        <input type=text class=input name="tarjeta_housenumber" onChange="javascript:limpiaTexto(this);" size="10"></td>
    <td id="id_tarjeta_zipcode"><label> {_LABEL_CODIGO_POSTAL} </label>
        <input type=text class=input name="tarjeta_zipcode" onChange="javascript:limpiaTexto(this);" size="12"></td>
    <td id="id_tarjeta_city"><label> {_LABEL_CIUDAD} </label>
        <input type=text class=input name="tarjeta_city" onChange="javascript:limpiaTexto(this);" size="18"></td>
    <td id="id_tarjeta_state"><label> {_LABEL_ESTADO} </label>
        <input type=text class=input name="tarjeta_state" onChange="javascript:limpiaTexto(this);" size="18"></td>
  </tr>
