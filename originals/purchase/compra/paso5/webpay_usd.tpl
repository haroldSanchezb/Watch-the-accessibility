...
-->
    ...
    <td id="id_nombre_titular"><input type=text class=input name="nombre_titular" size='30' onChange="javascript:limpiaTexto(this);" value='{NOMBRE_TITULAR}'>
    </td>
  </tr>
  <tr>
    <td> {_LABEL_NUMERO_TARJETA}
      </th>
    <td id="id_n_tarjeta"><input type="hidden" name="tipo_venta" value="vn">
  ...
  <tr>
    ...
    <td id="id_tarjeta_address"><input type=text class=input name="tarjeta_address" onChange="javascript:limpiaTexto(this);" size="30"></td>
  </tr>
  <tr>
    <td>{_LABEL_CODIGO_VERIFICACION}</td>
    <td id="id_digito_verificador"><input type=text class=input name="digito_verificador" size="5" maxlength="{LARGO_DIGITO_VERIFICADOR}">&nbsp;&nbsp;<a href="javascript:mostrar_layer_cod();"><img src="/images/reservas/compra/help_icon2.gif" width="15" height="15" border="0" alt="{_TEXTO_LINK_AYUDA}"></a>&nbsp;&nbsp;<a href="javascript:mostrar_layer_cod();">{_TEXTO_LINK_AYUDA}</a></td>
    <td> {_LABEL_CIUDAD} </td>
    <td id="id_tarjeta_city"><input type=text class=input name="tarjeta_city" onChange="javascript:limpiaTexto(this);" size="18">
    </td>
  </tr>
  <tr>
    <td colspan=2>&nbsp;</td>
    <td> {_LABEL_CODIGO_POSTAL} </td>
    <td id="id_tarjeta_zipcode"><input type=text class=input name="tarjeta_zipcode" onChange="javascript:limpiaTexto(this);" size="12">
    </td>
  </tr>
