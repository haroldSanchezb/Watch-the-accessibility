...
<p>{_HTML_RESERVA_RESPETADA_2}</p>
	<br>
	<p>{_LABEL_IMPORTANTE}: {_MSG_HTML_POSIBLE_ADELANTO_1}<br>
  <!--	<a href="javascript:MM_openBrWindow('/cgi-bin/compra/show_oficinas.cgi?session_id={SESSION_ID}','nombre','width=600,height=520,scrollbars=yes');">{_PALABRA_OFICINAS}</a>.-->{_MSG_HTML_POSIBLE_ADELANTO_2}</p>
