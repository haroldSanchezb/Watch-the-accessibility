...
<table cellspacing="0" cellpadding="0" style="width: 600px; border: 1px solid #CCC; margin: 0 auto; margin-top: 15px; margin-bottom: 15px;">
  <tr style="background: #DCE0EE; font: 14px Arial, Helvetica, sans-serif; color: #363636; text-align: left;">
    <td colspan="8" style="font-weight: bold; padding: 4px 0 0 5px; border-bottom: 1px solid #ccc; background: #DCE0EE;">{_LABEL_ITINERARIO}</td>
  </tr>
  {*HEAD_ITINERARIO}
  <tr>
    ...
    <td style="padding: 4px 2px 3px 5px; border-right: 1px solid #ccc; background-color:#f3f4f9; font: 11px Arial, Helvetica, sans-serif; color: #003e7e; text-align: left;">{_LABEL_EQUIPAJE}</td>
  </tr>
  {/HEAD_ITINERARIO}
  <!--{*HEAD2}
  ...
  <tr>
    ...
    <td style="padding: 4px 2px 3px 5px; border-right: 1px solid #ccc; font: 11px Arial, Helvetica, sans-serif; color: #333; text-align: left;">{EQUIPAJE}</td>
  </tr>
  {/LINEAS_ITINERARIO}
</table>
