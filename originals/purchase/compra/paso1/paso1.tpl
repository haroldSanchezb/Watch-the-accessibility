...
function check_and_submit(f)
	...
	if (from != '' && to != '' && from == to)
		{
		change_bg_for_id('id_to_city1', 'dato-erroneo');
		errores += country_from + "{_ERROR_CIUDAD_DE_DESTINO_IGUAL_A_ORIGEN_JS}\n";
		}
                    ...
                    <table cellpadding="0" cellspacing="0" width="100%" class="table">
                        ...
                        <tr>
                            ...
                            <td id='id_to_city1' style="vertical-align: top;">
                                ...
                                <br>
                                <a title="{_TEXTO_LINK_MULTIPLES_DESTINOS}" href='/cgi-bin/compra/paso1.cgi?estilo=multiples_destinos&amp;rand=1234543'>{_TEXTO_LINK_MULTIPLES_DESTINOS}</a>
                            </td>
