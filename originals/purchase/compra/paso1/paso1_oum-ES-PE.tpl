...
<h1 style="text-align:center;"> &iexcl;Aprovecha las mejores tarifas para volar de aqu&iacute; a 6 d&iacute;as! </h1>
 <img src="/images/asociados/encabezados/es_cl_oum_750x150_int.jpg" class="img_float_right" width="750" height="150" alt="Volvieron las Ofertas de &Uacute;ltimo Minuto" title="Volvieron las Ofertas de &Uacute;ltimo Minuto">
 <p style="font-size:14px; font-family:Arial, Helvetica, sans-serif; color:#666666">{_MSG_OUM_NO_DISPONIBLE}<br />
  Esc&aacute;pate dentro de los pr&oacute;ximos 6 d&iacute;as a cualquiera de estos destinos   comprando tu pasaje a incre&iacute;bles precios, para viajes ida y vuelta en   cabina Economy. Son solo 5 asientos por destino. Recuerda revisar estas   Ofertas regularmente, porque muy pronto &iexcl;Aparecer&aacute;n nuevas ofertas!</p>
  <p><a href="http://www.lan.com/promociones/index.html">Ver otras promociones de LAN.com</a></p>
 {_MSG_OUM_NO_APLICAN_INFANTES} <br />
 
 <div>
<!--PARA ACTIVAR TABS DE OUM QUITAR ESTILO EN LINEA DISPLAY -->
 <ul id="promo-tab" style="display:none;">
 
   
   <li id="tab_internacional"><a href="javascript:mostrar('internacional');"><b>Destinos internacionales</b></a></li>
...
<div id="oum_internacional" style="display:yes">
