							...
							<tr>
								...
								<td style="white-space: nowrap; text-align: right;">
									<div class="ayuda_caja_compra">
										...
										<img style="cursor: pointer;" onclick="toggle_ayuda_caja_compra()" onmouseout="hide_ayuda_caja_compra()" src="/es_cl/images/common/help_icon2.gif" width="15" height="15" alt="Ayuda">&nbsp;
...
-->
			...
			<table class="pasajeros">
				<tr>
					...
					<td>
            			{+EXTRA_SENADO}          			</td>
					<td><span id="pregunta_flex"><input type="hidden" name="flex" value="1"><!--{_LABEL_FECHA_FLEXIBLE}--></span></td>
                    <!-- forzando matriz empresas / abravo : 28 02 2011 -->
				</tr>
				<tr>
				...
				<tr>
				   ...
				   <div id="bloque_horizontal_7">
				   <input name="next_step" onClick="check_and_submit(this.form)" type="button" value="{_LABEL_CONTINUAR}" tabindex="12" id="next_step" class="button-page blue">
				   </div>
			  </tr>
			</table>
		</div>
