...
<div class="bottom tasas">Precio final - Ida y vuelta </div>
		<div class="linea"></div>
		<div class="fila avion">
			...
			<h4>Canje de kms.</h4>
			{*BLOQUE_MONTO_KMS}<p>Desde <span class="tarifa"><strong>{MONTO_KMS} kms.</strong></span></p>
			{/BLOQUE_MONTO_KMS}
			<h5>&nbsp;</h5>
		</div>

		<!--<div class="linea"></div>-->
		<!--<div class="bottom tasas">{_MSG_PRECIO_TASAS_IMPUESTOS}</div>-->
	</div>
</div>
<!--FIN DESTINO -->
