...
<div id="layer_calendario1" style="position:absolute; width:94px; height:109px; z-index:0; left: 0px; top: 0px; visibility: hidden">
	<img name='imagen_calendario1' src='/images/html/imagen1x1.gif' usemap='#MapCalendario' border='0' width=94 height=109 alt='{_PALABRA_CALENDARIO_IDA}'>
	<br>
</div>
<div id="layer_calendario2" style="position:absolute; width:94px; height:109px; z-index:0; left: 0px; top: 0px; visibility: hidden">
	<img name='imagen_calendario2' src='/images/html/imagen1x1.gif' usemap='#MapCalendario' border='0' width=94 height=109 alt='{_PALABRA_CALENDARIO_VUELTA}'>
	<br>
</div>
  ...
  <tr>
    <td>
      <table width='100%' border='0' cellpadding='0' cellspacing='0'>
          ...
          <td>
            <table width="80%" border="0" cellpadding="0" cellspacing="0">
              <tr>
                ...
                <td>
                  <img src='/images/html/ico_calendario.gif' width=25 height=20 alt='{_PALABRA_CALENDARIO}' name='calendario1' border="0" onclick="activate_calendar_segun_form(document.paso1,'1')" onmouseout="MM_swapImage('calendario1','','/images/html/ico_calendario.gif',0)">
                </td>
              </tr>
            </table>
          </td>
          ...
          <td>
            <table width="80%" border="0" cellpadding="0" cellspacing="0">
              <tr>
                ...
                <td>
                  <img src='/images/html/ico_calendario.gif' width=25 height=20 alt='{_PALABRA_CALENDARIO}' name='calendario2' border="0" onclick="activate_calendar_segun_form(document.paso1,'2')" onmouseout="MM_swapImage('calendario2','','/images/html/ico_calendario.gif',0)">
                </td>
              </tr>
            </table>
          </td>
        ...
        <tr>
          <td>
           <a href='/cgi-bin/compra/paso1.cgi?estilo=multiples_destinos&amp;rand={RAND_CHECK}'>{_TEXTO_LINK_MULTIPLES_DESTINOS}</a>
          </td>
          <td>&nbsp;
        ...
        <tr>
          ...
          <td>
            <input type='button' onClick='check_and_submit(this.form)' name='next_step' value='{_LABEL_CONTINUAR}' class=boton_destacado>
          </td>
        </tr>
      </table>
    </td>
