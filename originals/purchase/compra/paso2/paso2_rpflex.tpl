...
function check_and_submit_owflex(f)
	...
	if (flag == 'special')
		...
		{
		f.action='{URL_PREFIX}/cgi-bin/compra/paso3.cgi?just_refresh=1;session_id={SESSION_ID}{IS_RESERVA}';
		}
...
<div id="box_int_border_process" style="height:100%;">
...
<div id="nota">{_PASO2_FLEX_NOTA_PRECIO_FINAL}</div>
</div></div>
