	<div id="caja_no_logged" class="bloque" style="display:none">
		...
		<tr>
			<td>
			<img src="/images/common/socio_lp_180x140_fr.jpg" width="187" height="140" border="0" usemap="#espanol" alt="Acceso socios LANPASS" title="Acc&egrave;s membres LANPASS">
			<map name="espanol">
				<area shape="rect" coords="56,55,132,78" href="/cgi-bin/site_login.cgi?page={RETORNO}" alt="Rentrer">
				<area shape="rect" coords="23,102,98,117" href="{_URL_OLVIDO_CLAVE}" alt="Obtenir Cl&eacute;">
				<area shape="rect" coords="22,118,132,134" href="/cgi-bin/profile/usuario.cgi" alt="Inscription sur LANPASS">
			  </map>
			</td>
		</tr>
		</table>
	...
	<div id="caja_logged" class="bloque" style="display:none">
		...
		<tr>
			...
			<div id="cabecera_acceso_clientes_logged">
				<img src="/images/common/candado.gif" class="flotar_der" alt="" height="17" width="14">
