...
<form name="form_canje_lanpass" action="/no_js.html" method="GET">
  ...
  <div id="bloque_horizontal_1_cplp">
    <div class="bloque_texto_titulo">
      <p>{_MSG_CONOZCA_CANJE_LANPASS}</p>
    </div>
  ...
  <div id="bloque_horizontal_3_cplp">
    <div class="bloque_vertical_1">
      <div class="bloque_ciudad_origen">
      ...
      <div class="bloque_ciudad_destino">
  ...
  <div id="bloque_horizontal_4_cplp"><a class="button-page blue" href="javascript:canje_lanpass_check_and_submit(document.form_canje_lanpass);">{_PASO1_COL_BUSCA_VLO}</a></div>
