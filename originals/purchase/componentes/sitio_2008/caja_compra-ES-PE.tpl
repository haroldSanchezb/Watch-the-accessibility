...
<form name="paso1" action="/no_js.html" method="GET">
		...
		<div class="bloque1_2">
			...
			<div class="clear_fix tab_inf"></div>
			 <p class="multiples_destinos">
				<a href="/cgi-bin/compra/paso1.cgi?estilo=multiples_destinos" title="{_AYUDA_CAJA_COMPRA}" style="vertical-align:top;">{_TEXTO_LINK_MULTIPLES_CIUDADES}</a>
			</p>
		</div>
	...
	<div class="separador_corto_pe no_bg">
		<div class="bloque1_3">
			<label for="vuelos_adultos">{_LABEL_ADULTOS}</label> <span class="no_negrita_caja">{_LABEL_ADULTOS_CAJA}</span>
			<p>
		...
		<div class="bloque1_3">
			<label for="vuelos_ninos">{_LABEL_NINOS}</label> <span class="no_negrita_caja">{_LABEL_NINOS_CAJA}</span>
			<p>
		...
		<div class="bloque1_3">
			<label for="vuelos_infantes">{_LABEL_INFANTES}</label> 
			<span class="no_negrita_caja">{_ANO}</span>
      <p>
...
{_MSG_ALGUNAS_TARIFAS_SOLO_RESIDENTES_PERU}
	</div>
