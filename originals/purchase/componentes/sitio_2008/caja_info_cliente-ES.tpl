	<div id="caja_no_logged" class="bloque" style="display:none">
		...
		<tr>
			<td>
			<img src="/images/common/socio_lp_180x140_es.jpg" width="187" height="140" border="0" usemap="#espanol" alt="Acceso socios LANPASS" title="Acceso socios LANPASS">
			<map name="espanol">
	...
	<div id="caja_logged" class="bloque" style="display:none">
		...
		<tr>
			<td>
            <img class="bg_top" width="187" height="3" alt="" src="http://www.lan.com/images/common/bg_acceso_clientes.jpg"/>
