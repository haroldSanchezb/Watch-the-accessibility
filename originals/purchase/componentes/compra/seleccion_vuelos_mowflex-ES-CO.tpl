...
<!--				<p style="font-size: 11px; font-weight:normal; margin-bottom: 0;">
					<a title="{_VER_ASIENTO}" href="javascript:show_ver_asiento_{CABINA}();">{_VER_ASIENTO}</a>
				</p>-->
			</div>
		</td>
		<td rowspan="{ROWSPAN}" style="width: 1px; padding: 0;">
  ...
  <tr>
    <!--<td>{*FLECHA_AYER}<a title="{_LABEL_DIA_ANTERIOR}" href='#{FOCO_LLAMADA_OWFLEX}' onClick="cambiar_dia({ID_SEGMENTO}, '{FECHA_AYER}', '{LINK_PASO2_AYER}');" class="sinlinea" ><img src='http://www.lan.com/images/common/fle_simple_retroceder_ida.gif' alt='{_LABEL_DIA_ANTERIOR}' width="23" height="23" border='0' style=" vertical-align:bottom;"></a>&nbsp;{/FLECHA_AYER}</td> -->
    <td style=" vertical-align:middle; padding-bottom: 10px; text-align:left;">{FECHA_VUELO}</td>
    <!--<td>{*FLECHA_MANANA}&nbsp;<a title="{_LABEL_DIA_SIGUIENTE}" href='#{FOCO_LLAMADA_OWFLEX}' onClick="cambiar_dia({ID_SEGMENTO}, '{FECHA_MANANA}', '{LINK_PASO2_MANANA}');" class="sinlinea"><img src='http://www.lan.com/images/common/fle_simple_avanzar_ida.gif' alt='{_LABEL_DIA_SIGUIENTE}' width="23" height="23" border='0'></a>{/FLECHA_MANANA}</td> -->
  </tr>
</table>
</td>
		{*FAMILIASOW}
...
<!--    <th><a title="{_LABEL_SALIDA}" href='{SCRIPT_URL}?session_id={SESSION_ID}&amp;ordenar_vuelos_por=departure_time&amp;just_refresh=1'>{_LABEL_SALIDA}</a></th>
    <th><a title="{_LABEL_LLEGADA}" href='{SCRIPT_URL}?session_id={SESSION_ID}&amp;ordenar_vuelos_por=arrival_time&amp;just_refresh=1'>{_LABEL_LLEGADA}</a></th>
    <th><a title="{_LABEL_DURACION}" href='{SCRIPT_URL}?session_id={SESSION_ID}&amp;ordenar_vuelos_por=leg_duration&amp;just_refresh=1'>{_LABEL_DURACION}</a></th>-->
    <th>{_LABEL_SALIDA}</th>
	...
	<tr>
		<td style="border-top: solid 1px #f0f0f0;"><span onMouseOver="if (typeof(activa_flight_info) != 'undefined') activa_flight_info('{REAL_OPERADO_POR}', '{REAL_MARKETEADO_POR}', 'tooltip_flight_info', '{FLIGHT_STATS_QUERY}');" onMouseOut="if (typeof(desactiva_flight_info) != 'undefined') desactiva_flight_info();">{IMAGEN_CONVENIO}<strong>{AIRLINE_CODE} {NUMERO_VUELO}</strong><sup>{OPERADO_POR_INDEX}</sup></span><br>
			 <span class="material_vuelo">
			 	{*MATERIAL_DE_VUELO}<img src='/images/html/avion1.gif' alt='{_LABEL_AVION}' width="12" height="12" border='0'> {AVION}{/MATERIAL_DE_VUELO}
			</span>
			<br>{ESCALAS}{*INFO_TRANSBORDO} <br>
			{_LABEL_CONEXION_EN} {CITY_CODE}<br>
			<span onMouseOver="if (typeof(activa_flight_info) != 'undefined') activa_flight_info('{REAL_OPERADO_POR}', '{REAL_MARKETEADO_POR}', 'tooltip_flight_info', '{FLIGHT_STATS_QUERY}');" onMouseOut="if (typeof(desactiva_flight_info) != 'undefined') desactiva_flight_info();">{IMAGEN_CONVENIO}<strong>{AIRLINE_CODE} {NUMERO_VUELO}</strong><sup>{OPERADO_POR_INDEX}</sup></span><br>
 {*MATERIAL_DE_VUELO}<img src='/images/html/avion1.gif' alt='{_LABEL_AVION}' width="12" height="12" border='0'> {AVION}{/MATERIAL_DE_VUELO}<br>{ESCALAS}{/INFO_TRANSBORDO}</td>
	...
	{/TARIFASOWDI}
	{*TARIFASOWNA}
	<td id="tdfamilia{ID_FAMILIA}[{ID_SEGMENTO}][{ID_VUELO}]" style="background-color: {FF_BG_COLOR}; color: #666; border-top: solid 1px white; border-left: solid 1px white;">
...
<div style="display: none;" id="over" class="overbox">
	<div id="contmodal">
		<div class="close">
			...
			<div id="close_modal">
			<a title="{_LABEL_CERRAR}" href="javascript:hideLightbox();"><img src="/images/common/cerrar_lightbox.png" width="13" height="15" alt="{_LABEL_CERRAR}"></a>
...
<table width="100%" border="0" cellpadding="0" cellspacing="0">
  ...
  {*BLOQUE_TARIFA_SIN_TAX}
    <td><table width="100%" border="0" cellpadding="0" cellspacing="0" class="table_tarifa_borde" >
      <tr style="font-size: 15px">
        <td style="color:#333333; padding:8px 4px 4px 8px;"><b>{LABEL_TARIFA} (*) : &nbsp;</b></td>
        <td id="sumatarifas" style="font-weight: bold; text-align:right; float:right; color:#333333; padding:8px 4px 4px 8px;">&nbsp;</td>
      </tr>
  ...
  {*BLOQUE_TARIFA_CON_TAX}
    <td><table width="100%" border="0" cellpadding="0" cellspacing="0" class="table_tarifa_borde">
      <tr style="font-size: 12px">
        <td style="text-align:left; padding:8px 4px 4px 8px;">{_LABEL_TARIFA}:</td>
        <td id = "tarifa_sin_impuesto" style="text-align:right; padding:8px 4px 4px 8px;">{_LABEL_VALOR_PAGAR_SIN_IMPUESTOS}</td>
      </tr>
	  {DESPLIEGUE_SURCHARGE}
	  {DESPLIEGUE_FEE}
      <tr style="font-size: 12px">
        <td style="text-align:left; padding:8px 4px 4px 8px; padding:8px 4px 4px 8px;">{_LABEL_IMPUESTOS}:</td>
