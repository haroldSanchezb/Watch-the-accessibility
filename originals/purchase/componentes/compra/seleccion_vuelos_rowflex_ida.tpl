...
<div id="comparativa_familias" class="ydsf" style="display: none;">
	<div id<div id="comparativa_familias_inner" class="inner">
    <div class="texto_cerrar_comparativas"><a title="{_LABEL_CERRAR}" href="javascript:hide_comparativa_familias();">{_LABEL_CERRAR}</a></div>
		...
		<div id="comparativa_familias_footer">
			<a hre<a title="{_LABEL_CERRAR}" href="javascript:hide_comparativa_familias();"><img src="/images/common/cerrar_lightbox.png" width="13" height="15" alt="{_LABEL_CERRAR}"></a>
		</div>
	</div>
</div>
...
<script type="text/javascript">
	var f_ida = fecha_nueva_input_matriz;
	var form = 'document.forms.paso1';
	var way = document.getElementById('id_sentido').value;
	var radio_id = way + '_radio_' + f_ida + '|';
	var radio = document.getElementById(radio_id);
	if(radio)
		{
		radio.checked = true;
		set_fechas(form, f_ida, '');
		celda_mouse_over(form, f_ida, '');
		}	
</script>
