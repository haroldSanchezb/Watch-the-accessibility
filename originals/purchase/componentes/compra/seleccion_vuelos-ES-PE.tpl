...
<h4><div>{FROM_CITY} - {TO_CITY}</div> 
<img src="/images/html/indicator.gif" name="indicator" width="16" height="16" border="0" id="indicator{ID_SEGMENTO}" style="display:none;" alt="Loading..." class="indicator">
</h4>
