      ...
      <div id="formulario_cartola">
        <tr>
          <td><strong>{_LABEL_SOCIO_LANPASS}</strong><br>
            <input name="textfield" type="text" id="nro_mbr_nbr" value="{_MSG_INGRESE_NUMERO_SOCIO}" onFocus='clear_mbr_nbr(this);'/></td>
        </tr>
        <tr>
          <td><input type="button" class="boton-secundario" value="Ingresar" title="Ingresar" name="submitButton2" onclick='check_and_submit_get_kms()'/></td>
        </tr>
        <tr>
