...
<div style="padding-top:15px;" class="warning-info" id="msg-op">
  ...
  Para solicitudes de grupos con segmentos &uacute;nicamente de TAM o con itinerarios mixtos  TAM y LAN en donde el primer transportador  sea TAM, debe realizar su solicitud aTAM Group Desk: 598 29018 451.</p>
</div>
...
<td class="campo_tabla_form_proceso"><input name="group_name" type="text" size="30" maxlength="50" strto="UPPER">   <br />(S&oacute;lo letras y sin espacios. Ej: ColegioViajeMiami)</td>
</tr>
