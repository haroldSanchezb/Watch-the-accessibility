...
<h1>Buscar Solicitudes de Grupo</h1>

<div class="content_tb_process">
<h2 style="width:770px; margin-left:auto; margin-right:auto">Buscar por n&uacute;mero de solicitud</h2>
...
<table class="tabla_form_procesoo" width="100%" cellspacing="0"><tbody>
		...
		<tr> 
			<td class="dato_tabla_form_proceso" style="border-left:solid 1px #cccccc; border-bottom:solid 1px #cccccc; ">N&uacute;mero Solicitud</td>
    ...
    <input type="submit" name="Submit" value="Buscar" class="button-page float_right">
</form>
