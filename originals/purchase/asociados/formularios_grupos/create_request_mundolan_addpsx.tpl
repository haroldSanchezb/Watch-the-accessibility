...
<h1>Solicitud de Grupo (ADD-PAX)</h1>
...
<td><input name="group_name" type="text" size="30" maxlength="50">   (S&oacute;lo letras y sin espacios. Ej: ColegioViajeMiami)
</td>
</tr>
...
<tr>
<td class="sub-titulo">PNR Original</td>
<td>
	<input name="pnr_host" type="text" size="6" maxlength="6" onChange="this.value = this.value.toUpperCase();" readonly>
</td>
</tr>
<tr>
<td class="sub-titulo">Fecha Creaci&oacute;n PNR</td>
<td><input name="creation_date_pnr" type="text" size="10" maxlength="10" readonly>
</td>
</tr>
...
<tr>
<td class="sub-titulo">Total de Pasajeros</td>
<td><input name="total_pax" type="text" size="5" maxlength="3" value="0"> 
(Suma de Adultos y Child)
</td>
</tr>
