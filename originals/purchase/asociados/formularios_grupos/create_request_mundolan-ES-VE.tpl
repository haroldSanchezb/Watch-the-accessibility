...
<div style="padding-top:15px;" class="warning-info" id="msg-op">
  ...
  Para solicitudes de grupos con segmentos &uacute;nicamente de TAM o con itinerarios mixtos TAM y LAN, debe realizar su solicitud a trav&eacute;s del correo: <a href="mailto:cotizaciones@lan.com">cotizaciones@lan.com</a>.</p>
</div>
...
<col width="14%">
<tr>
<tr><td colspan="6" class="encabezado_tabla_form_proceso" style="border-top:1px solid #cccccc">Segmentos de Vuelo</td></tr>
...
<tr>
<td class="dato_tabla_form_proceso"  style="width:30%">&nbsp;</td>
