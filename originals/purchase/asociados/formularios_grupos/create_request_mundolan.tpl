...
<!--<div style="padding-top:15px;" class="warning-info" id="msg-op"><p>En esta secci&oacute;n puede realizar &uacute;nicamente solicitudes  de grupos que al menos tenga un tramo LAN. En el caso de itinerarios Mixtos (LAN y TAM), en esta secci&oacute;n recibiremos solicitudes s&oacute;lo si dentro del itinerario, el segmento de LAN es anterior al de TAM.<br />Para solicitudes de grupos con segmentos &uacute;nicamente de TAM o con itinerarios mixtos  TAM y LAN en donde el primer transportador  sea TAM, debe realizar su solicitud aTAM Group Desk: 56 2 4990225.</p></div>-->


<div class="content_tb_process">
<h2 style="width:770px; margin-left:auto; margin-right:auto">Formulario</h2>
...
<!--<td class="sub-titulo">{_LABEL_TELEFONO_CONTACTO_ML}
  <table cellspacing="0" cellpadding="0">
    
  </table></td>
<td><input name="phone_executive" type="text" size="15" maxlength="15"></td>
</tr>-->
...
<table class="tabla_form_proceso" width="600px" cellspacing="0" cellpadding="0"><col width="30%">
<col>
...
<table class="tabla_form_proceso" width="800px" cellspacing="0" cellpadding="0">
...
<td class="dato_tabla_form_proceso">Fecha Salida</td>
...
<td class="campo_tabla_form_proceso">
<input class="vuelo blockable" name="flight_number0" type="text" size="10" maxlength="4">
</td>
<td class="campo_tabla_form_proceso">	{+CALENDARIO(nc='1', fecha_iso_desde='{FECHA_DESDE}', fecha_iso_hasta='{FECHA_HASTA}', fecha_iso_inicio='{FECHA_DESDE}')}
...
<td class="campo_tabla_form_proceso">
<input class="vuelo blockable" name="flight_number1" type="text" size="10" maxlength="4">
</td>
<td class="campo_tabla_form_proceso">
...
<td class="campo_tabla_form_proceso">
<input class="vuelo blockable" name="flight_number2" type="text" size="10" maxlength="4">
</td>
<td class="campo_tabla_form_proceso">
...
<td class="campo_tabla_form_proceso">
<input class="vuelo blockable" name="flight_number3" type="text" size="10" maxlength="4">
</td>
<td class="campo_tabla_form_proceso">
...
<td class="campo_tabla_form_proceso">
<input class="vuelo blockable" name="flight_number4" type="text" size="10" maxlength="4">
</td>
<td class="campo_tabla_form_proceso">
...
<td class="campo_tabla_form_proceso">
<input class="vuelo blockable" name="flight_number5" type="text" size="10" maxlength="4">
</td>
<td class="campo_tabla_form_proceso">
...
<td class="campo_tabla_form_proceso">
<input class="vuelo blockable" name="flight_number6" type="text" size="10" maxlength="4">
</td>
<td class="campo_tabla_form_proceso">
...
<td class="campo_tabla_form_proceso">
<input class="vuelo blockable" name="flight_number7" type="text" size="10" maxlength="4">
</td>
<td class="campo_tabla_form_proceso">
...
<td class="campo_tabla_form_proceso">
<input class="vuelo blockable" name="flight_number8" type="text" size="10" maxlength="4">
</td>
<td class="campo_tabla_form_proceso">
...
<td class="campo_tabla_form_proceso">
<input class="vuelo blockable" name="flight_number9" type="text" size="10" maxlength="4">
</td>
<td class="campo_tabla_form_proceso">
...
<tr>
<td class="dato_tabla_form_proceso"  style="width:40%">&nbsp;</td>
...
<tr>
<td class="dato_tabla_form_proceso">El Grupo transporta equipaje especial?</td>
...
<tr>
<td class="dato_tabla_form_proceso">Cu&aacute;l?</td>
<td colspan="2" class="campo_tabla_form_proceso"><textarea name="detail_baggage"  style="width:90%; height:80px;" cols="1" rows="1"></textarea>
</td>
</tr>
