...
<div style="padding-top:15px;" class="warning-info" id="msg-op">
  ...
  Para solicitudes de grupos con segmentos &uacute;nicamente de TAM o con itinerarios mixtos  TAM y LAN en donde el primer transportador  sea TAM, debe realizar su solicitud aTAM Group Desk: 01800 5181780.</p>
</div>
