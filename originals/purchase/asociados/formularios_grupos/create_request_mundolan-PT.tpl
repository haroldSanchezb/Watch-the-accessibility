...
<h1>Solicita&ccedil;&atilde;o de Grupo</h1>
...
<h2 style="width:770px; margin-left:auto; margin-right:auto">Solicita&ccedil;&atilde;o de Grupo</h2>
...
<col width="30%">
<col>
<tr><td colspan="2" class="encabezado_tabla_form_proceso">Informa&ccedil;&atilde;o da Agencia</td></tr>
<tr>
<td class="dato_tabla_form_proceso">Nome da Agencia</td>
...
<tr>
<td class="dato_tabla_form_proceso">IATA Agencia </td>
...
<col width="30%">
<col>
<tr><td colspan="2" class="encabezado_tabla_form_proceso">Agente de Viagem</td></tr>
<tr>
<td class="dato_tabla_form_proceso">Nome do Agente</td>
...
<tr>
<td class="dato_tabla_form_proceso">E-mail</td>
...
<!--<td class="dato_tabla_form_proceso">{_LABEL_TELEFONO_CONTACTO_ML}
...
<col width="30%">
<col>
<tr><td colspan="2" class="encabezado_tabla_form_proceso">Tipo de Solicita&ccedil;&atilde;o</td></tr>
<tr>
...
<tr>
<td class="dato_tabla_form_proceso">Motiva&ccedil;&atilde;o da Viagem </td>
<td class="campo_tabla_form_proceso">
...
<tr>
<td class="dato_tabla_form_proceso">Produto</td>
<td class="campo_tabla_form_proceso">
...
<col width="30%">
<col>
<tr><td colspan="2" class="encabezado_tabla_form_proceso">Informa&ccedil;&atilde;o do Grupo</td></tr>
<tr>
<td class="dato_tabla_form_proceso">Nome do Grupo</td>
<td class="campo_tabla_form_proceso"><input name="group_name" type="text" size="30" maxlength="50" strto="UPPER">   (Somente letras e sem espa&ccedil;os. Por exemplo, ColegioViajeMiami)</td>
</tr>
...
<td class="campo_tabla_form_proceso"><input name="fare_basis" type="text" size="10" maxlength="10">
</td>
</tr>-->
</table>
...
<col width="14%">
<tr>
<tr><td colspan="6" class="encabezado_tabla_form_proceso" style="border-top:1px solid #cccccc">Itiner&aacute;rio</td></tr>

<td class="dato_tabla_form_proceso">Cia A&eacute;rea</td>
<td class="dato_tabla_form_proceso">Voo</td>
<td class="dato_tabla_form_proceso">Data de Sa&iacute;da</td>
<td class="dato_tabla_form_proceso">Origem</td>
<td class="dato_tabla_form_proceso">Destino</td>
<td class="dato_tabla_form_proceso">Classe de Servi&ccedil;o</td>
</tr>
...
<tr><td colspan="3" class="encabezado_tabla_form_proceso">Informa&ccedil;&otilde;es Adicionais</td></tr>

<tr>
<td class="dato_tabla_form_proceso" width="30%">&nbsp;</td>
<td class="dato_tabla_form_proceso">Sim</td>
<td class="dato_tabla_form_proceso">N&atilde;o</td>
</tr>

<tr>
<td class="dato_tabla_form_proceso">&Eacute; poss&iacute;vel dividir o grupo?</td>
...
<tr>
<td class="dato_tabla_form_proceso">Aceita Alternativas?</td>
...
<tr>
<td class="dato_tabla_form_proceso">Deseja adicionar alguma informa&ccedil;&atilde;o?</td>
...
<tr>
<td class="dato_tabla_form_proceso">Observa&ccedil;&otilde;es, Bagagem especial)</td>
<td colspan="2"><textarea name="detail_baggage"  style="width:90%; height:80px;" ></textarea>
</td>
</tr>
