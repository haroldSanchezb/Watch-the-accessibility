...
function ValidacionFomulario(form)
  {
 	if(Empty(form.elements["rut_agente"].value))
    {
  ...
  if (form.elements["password2"].value != form.elements["password"].value)
    {
    alert('El password de confirmacion es incorrecto.');
    form.password2.focus();
    return false;
    }
  }
...
<h4>Datos del nuevo Administrador de la empresa</h4>
...
<form name="formulario" method="post" action="inscripcion.cgi" onsubmit="return ValidacionFomulario(this)">
	...
	<p>Para quedar habilitado como un Administrador de esta agencia debe digitar su nombre completo, 
	un nombre de usuario y una clave secreta personal. Una vez registrada la informaci&oacute;n
	podr&aacute; ingresar a nuestro sistema.</p>
	...
	<table class="table" width="100%" border="0" cellspacing="0" cellpadding="0">
		...
		<tr> 
			<td class="sub-titulo">DNI del agente de ventas</td>
