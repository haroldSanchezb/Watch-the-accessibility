                                ...
                                <td>
                                    <table class="tabla_form_proceso" style="width:100%; margin:0 auto;" cellspacing="0" cellpadding="0">
                                        <colgroup><col width="60%"><col>
                                            ...
                                            <td class="encabezado_tabla_form_proceso" colspan="2">Do a search for your ticket</td>
                                        </tr>
                                        <tr>
                                            <td class="dato_tabla_form_proceso">Ticket number</td>
                                            <td class="campo_tabla_form_proceso"><input type='text' name='numtkt' class="input"><br>
                                            Ex. 045-2123123456</td>
                                            
                                        </tr>
                                        <tr>
                                            <td class="dato_tabla_form_proceso">Passenger&acute;s last name</td>
                                            <td class="campo_tabla_form_proceso"><input type='text' name='pax_name' class="input"><br>&nbsp;</td>
                                        </tr>                               
                                    </tbody></table>
									<input type="submit" onclick="check_and_submit_pnr(this.form)" value="Search" class="button-page float_right" name="Submit" style="margin-right:18px;">
