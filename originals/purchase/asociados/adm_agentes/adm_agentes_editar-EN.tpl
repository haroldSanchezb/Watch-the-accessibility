...
function check_form_editar_agente(f)
	...
	if (f.elements['id_sucursal'].selectedIndex<=0)
		{
		alert('You must enter an agency')
...
<h1>Edit agent personal information </h1>
...
<form action='adm_agentes.cgi' onsubmit='return(check_form_editar_agente(this))'>
	...
	<p><input type='submit' class="boton-destacado" value='Apply changes' onfocus="blur()" name="aplicar">
	</p>
