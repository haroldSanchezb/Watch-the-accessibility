...
<tr>
	        ...
	        <td><input name="numero_socio2" type="text" id="numero_socio2" size="30" maxlength="9" value="{+ASOCIADOS_INFO('numero_socio2')}"></td>
                ...
                <table class="table" width="100%"  border="0" cellspacing="0" cellpadding="0">
			      ...
			      <td><input name="clase_adulto" type="radio" value="Kms"></td>
                              ...
                              <tr>
			      <td class="sub-titulo">Impuestos</td>
			      <td><input name="clase_child" type="radio" value="Impuestos"></td>
                	      </tr>

			      <tr>
                              <td class="sub-titulo">Kms+Impuestos</td>
	...
	<h5>Recuerde que solo son validas para cobro de premios Lanpass las calses T y U </h5>	
	<table class="table" width="100%"  border="0" cellspacing="0" cellpadding="0">
		<col>
		<col width="18%">
		<col width="18%">
	...
	<p><strong>IMPUESTOS SUJETOS A CAMBIO SIN PREVIO AVISO<br>COTIZACIONES S&Oacute;LO PARA PASAJEROS INDIVIDUALES</strong></p>
