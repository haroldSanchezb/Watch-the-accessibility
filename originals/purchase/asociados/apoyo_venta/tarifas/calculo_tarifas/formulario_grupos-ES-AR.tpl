...
<div style="padding-top:15px;" class="warning-info" id="msg-op">
  ...
  Para solicitudes de grupos con segmentos &uacute;nicamente de TAM o con itinerarios mixtos  TAM y LAN en donde el primer transportador  sea TAM, debe realizar su solicitud aTAM Group Desk: 54 11 4819 6999.</p>
</div>
...
<form name="formulario" method="POST" action='/cgi-bin/formulario/envia_formulario.cgi' onSubmit="return ValidacionFomulario(this)">
	...
	<div>
		<input type='hidden' name='id_formulario' value='88'>
