...
<form name="formulario" method="POST" action='/cgi-bin/formulario/envia_formulario.cgi'>
	...
	<div>
		<input type='hidden' name='id_formulario' value='137'>
	...
	<table class="table" width="100%"  border="0" cellspacing="0" cellpadding="0">
		<tr>
			<td>
				...
				Ticket Lan Chile <input name="num_ticket1" type="text" class="input" id="num_ticket1" size="4" maxlength="3"> - <input name="num_ticket2" type="text" class="input" id="num_ticket2" size="5" maxlength="4"> - <input name="num_ticket3" type="text" class="input" id="num_ticket3" size="7" maxlength="6">
			</td>
		</tr>
		<tr>
			<td>
