...
<form name="formulario" method="POST" action='/cgi-bin/formulario/envia_formulario.cgi'>
	...
	<table class="table" width="100%"  border="0" cellspacing="0" cellpadding="0">
		...
		<tr>
			 <td class="sub-titulo">Tipo Agencia</td>
			 <td>
                         <select name='tipo_agencia'>
 	                <option value='Seleccione Aqui'selected>Seleccione Aqui</option>
...
<!--		<tr>
	...
	<table class="table" width="100%"  border="0" cellspacing="0" cellpadding="0">
		<tr>
			<td>
				...
				Ticket Lan <input name="num_ticket1" type="text" class="input" id="num_ticket1" size="4" maxlength="3"> - <input name="num_ticket2" type="text" class="input" id="num_ticket2" size="5" maxlength="4"> - <input name="num_ticket3" type="text" class="input" id="num_ticket3" size="7" maxlength="6">
			</td>
		</tr>
		<tr>
			<td>
				...
				enviar imagen digital del tkt o v&iacute;a fax al 565 28 53
			</td>
		</tr>
		<tr>
	...
	<p><input type="button" name="Submit" class="button-page" value="Enviar" onclick="check_and_submit(this.form)"></p>
