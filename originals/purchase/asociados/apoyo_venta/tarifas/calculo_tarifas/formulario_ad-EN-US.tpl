...
<form name="formulario" method="POST" action='/cgi-bin/formulario/envia_formulario.cgi' onSubmit="return ValidacionFomulario(this)">
	...
	<div>
		<input type='hidden' name='id_formulario' value='65'>
...
<p>Once your request has been approved and confirmed, please request your Credit Card Authorization Form to your LAN Inside Sales representative to 
