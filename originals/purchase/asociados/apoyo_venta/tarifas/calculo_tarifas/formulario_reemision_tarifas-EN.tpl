...
<form name="formulario" method="POST" action='/cgi-bin/formulario/envia_formulario.cgi'>
	...
	<table class="table" width="100%"  border="0" cellspacing="0" cellpadding="0">
		...
		<tr>
		  <td>
			  ...
			  E-TICKET Other carriers. <strong>Note:</strong>
		    Please send the ticket image via fax to our Rate Department, Santiago - Chile (56-2) 565 2853 </td>
		</tr>
		<tr>
			<td>&nbsp;</td>
		</tr>
	...
	<table class="table" width="100%"  border="0" cellspacing="0" cellpadding="0">
		...
		<tr>
			...
			<th>Carrier</th>
			<th>Class</th>
			<th>Date (dd/mm/aaaa) Ex:23/02/2009</th>
		</tr>
		<tr>
			<td>&nbsp;</td>
