...
<form name="formulario" method="POST" action='/cgi-bin/formulario/envia_formulario.cgi' onSubmit="return ValidacionFomulario(this)">
	...
	<div>
		<input type='hidden' name='id_formulario' value='130'>
  ...
  <p>REQUEST MUST BE SENT AT LEAST 10 DAYS PRIOR TO DEPARTURE</p>
	...
	<table class="table" width="100%"  border="0" cellspacing="0" cellpadding="0">
		...
		<tr>
			<td class="sub-titulo">Adress, City, State, Zip Code</td>
			<td><input name="adress" type="text" id="asistente" size="30" maxlength="250"></td>
		</tr>
		<tr>
	...
	<h2>Passenger Information<span style="font-size:12px;">&nbsp;&nbsp;(as shown in passport)</span></h2> 
	...
	<table class="table" width="100%"  border="0" cellspacing="0" cellpadding="0">
		...
		<tr>
            ...
            <td><input name="date_birth_1" type="text" id="date_birth_1" size="20" maxlength="20"></td>
            <td><input name="agency_relation_1" type="text" id="agency_relation_1" size="20" maxlength="20"></td>
			<td>
		...
		<tr>
            ...
            <td><input name="date_birth_2" type="text" id="date_birth_2" size="20" maxlength="20"></td>
            <td><input name="agency_relation_2" type="text" id="agency_relation_2" size="20" maxlength="20"></td>
			<td>
		...
		<tr>
            ...
            <td><input name="date_birth_3" type="text" id="date_birth_3" size="20" maxlength="20"></td>
            <td><input name="agency_relation_3" type="text" id="agency_relation_3" size="20" maxlength="20"></td>
			<td>
		...
		<tr>
            ...
            <td><input name="date_birth_4" type="text" id="date_birth_4" size="20" maxlength="20"></td>
            <td><input name="agency_relation_4" type="text" id="agency_relation_4" size="20" maxlength="20"></td>
			<td>
		...
		<tr>
            ...
            <td><input name="date_birth_5" type="text" id="date_birth_5" size="20" maxlength="20"></td>
            <td><input name="agency_relation_5" type="text" id="agency_relation_5" size="20" maxlength="20"></td>
			<td>
            ...
            <td><input name="date_birth_6" type="text" id="date_birth_6" size="20" maxlength="20"></td>
            <td><input name="agency_relation_6" type="text" id="agency_relation_6" size="20" maxlength="20"></td>
			<td>
