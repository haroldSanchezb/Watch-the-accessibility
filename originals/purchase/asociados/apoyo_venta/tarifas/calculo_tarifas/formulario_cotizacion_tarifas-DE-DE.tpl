...
<tr>
	...
	<table class="table" width="100%"  border="0" cellspacing="0" cellpadding="0">
                ...
                <tr>
                        <td class="sub-titulo">Kleinkind</td>
	...
	<h4>Anfragetyp*</h4>
 		<table class="table" width="100%"  border="0" cellspacing="0" cellpadding="0">		
				<tr>
      <td class="sub-titulo">Gruppe</td>
       <td><input name="clase_solicitud" type="radio" value="Grupo"></td>        
                </tr>

				<tr>
       <td class="sub-titulo">Einzelperson</td>
...
<table class="table" width="100%"  border="0" cellspacing="0" cellpadding="0">
	...
	<p> Im Falle einer Anfrage mit &bdquo;Surface&ldquo;-Abschnitt ist in die folgenden Spalten &bdquo;X&ldquo; einzugeben: Stadt XXX, Fluggesellschaft XX, Flugklasse X</p>
		
<p>
		 <input class="button-page" type="button" name="Submit" value="SENDEN" onclick='check_and_submit(this.form)' />
	</p>
	
	<p>* Dies sind Pflichtfelder.</p>
  <p><strong>TARIFE, DIE OHNE VORHERIGE ANK&Uuml;NDIGUNG GE&Auml;NDERT WERDEN K&Ouml;NNEN<br />
    ANFRAGEN AUSSCHLIESSLICH F&Uuml;R EINZELTARIFE</strong></p>
</form>	
