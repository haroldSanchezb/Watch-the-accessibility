...
<div id="acceso_clientes">
	...
	<div id="cuerpo_acceso_clientes">
		<form id="form_caja_socio" name="caja_socio" action="/no_js.html" method="POST"  onSubmit="caja_socio_login_check_and_submit(); return false;">
    	    ...
    	    <input type="hidden" name="cm_target_action" value="{URL_REFERER}"> 
			...
			<div class="bloque">
				<input type="submit" class="btn_form flotar_der" value="Ingresar" >
			</div>
			...
			<p class="guardar_cambios">Guardar datos</p>
		</form>
