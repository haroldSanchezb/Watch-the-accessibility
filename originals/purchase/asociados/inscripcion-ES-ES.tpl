...
var fecha=new Date();
        ...
        form.rut_agente.value='ES-'+ fecha.getYear()+'-' + fecha.getMonth()+'-'+ fecha.getDate() + ' ' + fecha.getHours()+':'+ fecha.getMinutes() + ':' + fecha.getSeconds();

	alert rut_agente.value
  ...
  <p>Para quedar habilitado como un Administrador de esta empresa debe digitar 
	...
	<table class="table" width="100%" border="0" cellspacing="0" cellpadding="0">
		...
		<tr> 
			...
			<td><input name="rut_agente" type='hidden' class="input" value="{RUT_AGENTE}"></td>
		</tr>

<tr>
<td> <li><a href="/html/lanpass/seguridad_popup.html">Seguridad de Datos</a></li></td>
</tr>
