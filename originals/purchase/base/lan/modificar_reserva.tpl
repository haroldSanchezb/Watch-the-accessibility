...
<div id="espera2" style="position:absolute; width:100%; height:100px; z-index:2; left: 0px; top: 200px; visibility: hidden; text-align: center" >{ESPERA2}</div>
  ...
  <table width="100%" height="100%" border="0" cellpadding="0" cellspacing="0">
    ...
    <table border="0" cellspacing="0" cellpadding="0" width='100%'>
      ...
      <tr>
        <td class="txt-paso-inactivo" id='txt_paso1'><a href='javascript:just_refresh_paso_n("1", "{NUMERO_PASO}", "{SESSION_ID}")' class='link-paso-txt'>Reservas</a></td>
        <td class="txt-paso-inactivo" id='txt_paso2'><a href='javascript:just_refresh_paso_n("2", "{NUMERO_PASO}", "{SESSION_ID}")' class='link-paso-txt'>Opciones</a></td>
        <td class="txt-paso-inactivo" id='txt_paso3'><a href='javascript:just_refresh_paso_n("3", "{NUMERO_PASO}", "{SESSION_ID}")' class='link-paso-txt'>Selecci&oacute;n</a></td>
        <td class="txt-paso-inactivo" id='txt_paso4'><a href='javascript:just_refresh_paso_n("4", "{NUMERO_PASO}", "{SESSION_ID}")' class='link-paso-txt'>Confirmaci&oacute;n</a></td>
        <td>&nbsp;</td>
