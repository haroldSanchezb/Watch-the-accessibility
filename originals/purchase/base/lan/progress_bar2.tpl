...
function chequea_progreso()
	{
	url = '/cgi-bin/wait2.cgi?show=progress&t={TIMEOUT}&unique_id={UNIQUE_ID}&check={CHECK}';
	loadXMLDoc(url);
	}
...
var locationAfterPreload = "/cgi-bin/wait2.cgi?show=page&t={TIMEOUT}&unique_id={UNIQUE_ID}&check={CHECK}" // URL of the page after preload finishes
