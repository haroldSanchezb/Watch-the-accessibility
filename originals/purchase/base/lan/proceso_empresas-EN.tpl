	...
	{+TEMPLATE('/base/lan/google_tag_manager.tpl')}
		<div id=externo>
			...
			<!--<div id="top" class="img_top_es">
					...
					<a href='/forbusiness/index.html'><img src='/images/logos/logo_empresas_en_new.gif' width=200 height=65 id="logo_empresas" alt='logo LAN'></a>
				</div>-->
...
<!-- FOOTER -->
				...
				<div id="footer-creditos">
					<div class="left">{_COPYRIGHT} - {_TEXTO_DERECHOS_RESERVADOS}.</div>
    				<div class="right">
