					...
					<div id="barra-superior">
						<ul>
							<li class="last">
								...
								<img src="/images/html/fono.gif" alt="{_LABEL_LLAMENOS}" width="13" height="13">
								6872310</li>
						</ul>
					</div>
				</form>

				<div id="logo_chilecompra">
					<a href="{_URL_HOME}"><img src='/images/logos/logo_chilecompra.gif' width=200 height=55 alt='logo LAN'></a>
				</div>


				<div id="barra-usuario" style="height: 30px;">
					&nbsp;
				</div>
